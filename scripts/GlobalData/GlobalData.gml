...
global.actionLibrary = {
	...
	swap: {
		name: ["Swap", "Warp", "Rescue"], //probably redundant to have a name but keep it
		description: ["Swap the positions of 2 allies. Can include yourself", "Move an adjacent ally to an empty nearby space. Can include yourself", "Moves a nearby ally to an adjacent empty tile"],
		cost: [5, 5, 7],
		subMenu: 0, //does it show up on screen or is it in a submenu
		userAnimation: "attack",
		//effectSprite: baseAttack,
