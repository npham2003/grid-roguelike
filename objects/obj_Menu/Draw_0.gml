...
if (win > 0){
	...
	if (winlose_anim_complete) {
		...
		draw_set_font(fnt_chiaro);
		draw_text_transformed(room_width/2, room_height/2 + 150, "PRESS "+string_upper(input_binding_get_name(global.other_controls[4]))+" TO RETURN TO MAIN MENU", 0.8, 0.8, 0);
