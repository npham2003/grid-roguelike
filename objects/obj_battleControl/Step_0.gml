	...
	case BattleState.PlayerWaitingAction:
		...
		if(unit!=pointer_null){
			...
			if(unit.ally){
				...
				//obj_menu.set_text(""string_upper(input_binding_get_name(global.other_controls[0]+string_upper(input_binding_get_name(global.other_controls[1]+string_upper(input_binding_get_name(global.other_controls[2]+string_upper(input_binding_get_name(global.other_controls[3]"+" - Move Cursor\nSpace - Select Unit\nJ - "+unit.actions[0].name+"\nK - "+unit.actions[1].name+"\nL - "+unit.actions[2].name+"\n; - "+unit.actions[3].name+"\nEnter - End Turn");
