...
total_options=array_length(tips);
}
...
update_names = function() {
	...
	//show_debug_message(controls_list);
	//show_debug_message(input_binding_get("up"));
}
